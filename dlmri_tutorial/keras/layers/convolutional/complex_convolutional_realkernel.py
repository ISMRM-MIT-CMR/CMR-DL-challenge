...
from dlmri_tutorial.keras.layers.convolutional import complex_conv as complex_nn_ops
from dlmri_tutorial.keras.layers import complex_act as activations
...
class ComplexConv2DTest(unittest.TestCase):
    def _test_fwd(self, conv_fun, kernel_size, strides, dilations, activation, padding):
        ...
        x = dlmri_tutorial.random_normal_complex(shape, tf.float32)
        Kx = model(x)
        #print(Kx.shape)
